...
import { 
  ...
  User, Mail, Phone, Calendar, Users, HeartHandshake, Smile, ShieldCheck, Zap
} from 'lucide-react'
import { useScrollReveal } from '../../hooks/useScrollReveal'

const BENEFITS = [
  'Fun and age-appropriate basketball',
  'Confidence, teamwork, and sportsmanship',
  'A welcoming environment for developing players',
  'More playing, exploring, and learning',
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <p className="text-eco-muted-light text-sm sm:text-base leading-relaxed">
                    You’re on the list! We’ll let you know as soon as EcoHoops Jr. program dates and registration details are available.
                  </p>
                  <button
                    type="button"
                    onClick={() => setStatus('idle')}
                    className="btn-ghost !py-2.5 !px-6 text-xs uppercase tracking-wider font-heading font-bold"
                  >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {(['Jr. NBA', 'Jr. WNBA', 'Not Sure Yet'] as const).map((option) => (
                        <label
                          key={option}
                          className={`flex items-center justify-center px-3 py-2.5 rounded-xl border text-xs font-heading font-bold cursor-pointer transition-all text-center ${
                            formData.programInterest === option
